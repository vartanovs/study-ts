/**
 * @module MaxHeap.ts
 * @description Binary Max Heap Class
 */
...
class MaxHeap {
  ...
  public extract() {
    ...
    // Swap top node with smaller child node until it's no longer smaller than its child
    while (
      currChildIndex !== currNodeIndex &&
